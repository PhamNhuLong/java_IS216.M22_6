...
//            DuLieuBang.Load(sql, tbDauSach);
            ...
            String sql1 = "select TENDAUSACH,TACGIA, NXB, NAMXB, SANCO \n" +
                           "from DAUSACH\n" +
                           "where lower(TENDAUSACH) like lower('%" +this.txtTimKiem.getText()+"') || '%'"
                           + "or lower(TACGIA) like lower('%"+this.txtTimKiem.getText()+"') || '%'"
                           +"or lower(NXB) like lower('%"+this.txtTimKiem.getText()+"') || '%'"
                           +"or lower(NAMXB) like lower('%"+this.txtTimKiem.getText()+"') || '%'";             
