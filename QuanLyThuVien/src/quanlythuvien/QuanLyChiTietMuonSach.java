...
public class QuanLyChiTietMuonSach extends javax.swing.JFrame {
    ...
    public static String sql1 = "select count(*) as tong from CTMS ";
    ...
    DuLieuBang.Load(sql, tbChiTietMuonSach);
     ...
     public int dem(){
        ...
        try {
            ...
            Logger.getLogger(QuanLyChiTietMuonSach.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TimKiemActionPerformed
        ...
        {
            String sql2 = " select * from CTMS where lower(MAPHIEUMUONSACH) like lower('%"+this.txtMaPhieuMuonSach.getText()+"%') ";
            DuLieuBang.Load(sql2, tbChiTietMuonSach);
        }
        else if(this.txtMaSach.getText().length()!=0)
            {
            String sql1 = " select * from CTMS where lower(MASACH) like lower('%"+this.txtMaSach.getText()+"%') ";
            DuLieuBang.Load(sql1, tbChiTietMuonSach);
            }
        else if(this.txtTimKiem.getText().length()!=0)
        {
            String sql3 = " select * from CTMS where lower(MAPHIEUMUONSACH) like lower('%"+this.txtTimKiem.getText()+"%')"
        ...
        else
        {
            try{        
                ...
                showtb();
                      ...
                      JOptionPane.showMessageDialog(null, "Thêm không thành công, cuốn sách này đang cho mượn.","Thông báo",1 );    
                      showtb();
                }
        }
            }
            catch(Exception e)
                {
                  //  JOptionPane.showMessageDialog(null, "Lỗi: "+ e.getMessage(),"Thông báo",1 );
                      if(e.getMessage().contains("ORA-00001: unique constraint (SINHVIEN02.PK_CTMS) violated"))
                      JOptionPane.showMessageDialog(null, "Thêm không thành công. Mã CTMS đã tồn tại!", "Lỗi", JOptionPane.WARNING_MESSAGE); 
                  //ORA-04088:
                  if(e.getMessage().contains("ORA-04088"))
                      JOptionPane.showMessageDialog(null, "Thêm không thành công, độc giả này đã mượn 3 cuốn sách!", "Lỗi", JOptionPane.WARNING_MESSAGE); 
